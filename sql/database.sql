...
CREATE TABLE UserAchievements (
  ...
  FOREIGN KEY (user_id) REFERENCES TwitchViewers(user_id),
  FOREIGN KEY (channel_id) REFERENCES TwitchChannel(channel_id),
...
INSERT INTO TwitchChannel (channel_id, channel_name, created_at, active)
VALUES (102790513, 'noraschair', CURRENT_TIMESTAMP, 1);
INSERT INTO TwitchChannel (channel_id, channel_name, created_at, active)
VALUES (120102983, 'asecrettoeverybody', CURRENT_TIMESTAMP, 0);
INSERT INTO TwitchChannel (channel_id, channel_name, created_at, active)
VALUES (84507934, 'emmagrus', CURRENT_TIMESTAMP, 0);


INSERT INTO Categories (category_id, category_name, channel_id) 
VALUES (1, "EmoteCount", NULL);

INSERT INTO Categories (category_id, category_name, channel_id) 
VALUES (3, "TotalMessagesSent", NULL);
